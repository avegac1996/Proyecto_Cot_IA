...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("seleccionado", sa.Boolean(), nullable=False, server_default=sa.text("true")),
        sa.Column("opciones_proveedores", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
